...
def modules_md():
    L = ["# Chips and modules — real pinouts\n",
         "Generated by `tools/gen_page.py`. Boards seen from above, antenna / SMA / trimpot at the top, USB at the bottom.",
...
""" + "<script>" + MOD_JS + "</script>\n"
    (LAYOUT / "breadboard.html").write_text(html, encoding="utf-8")
    modules_md()
